...
blocks:
  ...
  - _template: content
    body: |
      ...
      So we built a CMS on top of the tools developers already trust - Git and Markdown - and gave content creators a live, visual way to work inside them. No proprietary database. No content held hostage. Just your words, in your own harbour, editable by anyone on the crew.
  - _template: callout
    text: Open source and Apache 2.0 licensed - charted in the open with our community
    url: 'https://github.com/tinacms/tinacms'
  - _template: features
    title: What we stand for
    description: A few convictions that steer every decision we make.
    items:
      - icon: code
      ...
      - icon: lock-open
        ...
        text: |
          Your content lives in your repo as plain Markdown. Cast off whenever you like and take all of it with you.
  - _template: stats
